<template>
  <div>
              ...
              <a-tab-pane key="html">
                <span slot="tab">
                  <a-icon
                    ...
                    :style="{
                      color: activeTab === 'html' ? '#f1fa8c' : '#a95812',
                    }"
                  />
                  template
                </span>
              ...
              <a-tab-pane key="js">
                <span slot="tab">
                  <a-icon
                    ...
                    :style="{
                      color: activeTab === 'js' ? '#f1fa8c' : '#a95812',
                    }"
                  />
                  script
                </span>
              ...
              <a-tab-pane key="css">
                <span slot="tab">
                  <a-icon
                    ...
                    :style="{
                      color: activeTab === 'css' ? '#f1fa8c' : '#a95812',
                    }"
                  />
                  css
                </span>
    ...
    <resource-dialog ref="resourceDialog" @save="setResource" />
...
import { makeUpJs, makeUpSetup } from "@/components/generator/js";
...
export default {
    ...
    const clipboard = new ClipboardJS(".copy-btn", {
      text: (trigger) => {
        ...
        this.$notification.success({
          ...
          description: this.$t("base.code.copy.successfully"),
        });
        return codeStr;
      },
    });
  ...
  methods: {
    ...
    onOpen(formData, generateConf) {
      ...
      this.setupCode = makeUpSetup(formData, this.jsCode);
      this.cssCode = makeUpCss(formData);

      loadBeautifier((btf) => {
        beautifier = btf;
        this.htmlCode = beautifier.html(this.htmlCode, beautifierConf.html);
        this.setupCode = beautifier.js(this.setupCode, beautifierConf.js);
        ...
        loadMonaco((val) => {
          ...
          this.$nextTick(() => {
            ...
            this.setEditorValue("editorJs", "js", this.setupCode);
