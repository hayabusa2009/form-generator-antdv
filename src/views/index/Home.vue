    ...
    <a-layout :style="{ marginLeft: '250px', marginRight: '350px' }">
      ...
      <div class="center-main">
        <a-layout-content>
          <a-row
            :style="{
              padding: '24px',
              background: '#fff',
              minHeight: 'calc(100vh - 64px - 24px - 64px)',
            }"
          >
            <a-form-model
        ...
        <a-layout-footer :style="{ textAlign: 'center' }">
          ©2022
          <a
            href="https://github.com/fuzui/form-generator-antdv"
            target="_blank"
            >Form Generator Antdv</a
          >
        </a-layout-footer>
      </div>
    </a-layout>
  ...
  methods: {
    ...
    generateCode() {
      ...
      const script = vueScript(
        makeUpSetup(this.formData, makeUpJs(this.formData, type))
      );
