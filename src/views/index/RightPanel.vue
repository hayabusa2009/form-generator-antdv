  ...
  <div>
    ...
    <div class="right-main">
      ...
      >
            ...
            <a-row :gutter="8">
              <a-col :span="12">
                <a-input
                  ...
                  :placeholder="$t('base.source.title')"
                />
              </a-col>
              <a-col :span="12">
                <a-input
                  v-model="activeData.titles[1]"
                  :placeholder="$t('base.target.title')"
                />
              </a-col>
            </a-row>
          </a-input-group>
        ...
        <a-form-model-item
          v-if="activeData.__config__.tag === 'a-checkbox-group'"
          :label="$t('base.choose.least')"
        >
          <a-input-number
        ...
        >
          <a-space size="large">
            ...
            <a-button
              type="dashed"
              @click="openIconsDialog('addonBefore', true)"
            >
              {{ $t("base.icon.choose") }}
            </a-button>
            <a-button
        ...
        >
          <a-space size="large">
            ...
            <a-button
              type="dashed"
              @click="openIconsDialog('addonAfter', true)"
            >
              {{ $t("base.icon.choose") }}
            </a-button>
            <a-button
        ...
        >
          <a-input-number
            ...
            :placeholder="$t('base.total')"
          />
        </a-form-model-item>
        <a-form-model-item
          v-if="activeData.height !== undefined"
          :label="$t('base.component.height')"
        >
          <a-input-number
        ...
        <a-form-model-item v-if="isShowStep" :label="$t('base.step')">
          <a-input-number
            ...
            :placeholder="$t('base.step')"
          />
        </a-form-model-item>
        <a-form-model-item
          v-if="activeData.maxLength !== undefined"
          :label="$t('base.most.enter')"
        >
          <a-input
            v-model="activeData.maxLength"
            :placeholder="$t('base.maxlength')"
          >
        ...
        >
          ...
          >
            ...
            >
              ...
              <a-input
                v-model="item.label"
                :placeholder="$t('base.option.name')"
              />
              <a-input
        ...
        <template v-if="activeData.__config__.tag === 'a-transfer'">
          ...
          >
            <div
              v-for="(item, index) in activeData['data-source']"
              :key="item.key"
              class="select-item"
            >
              <div class="select-line-icon option-drag">
              ...
              <div
                class="close-btn select-line-icon"
                @click="activeData['data-source'].splice(index, 1)"
              >
                <a-icon type="minus-circle" />
              </div>
            </div>
        ...
        <a-form-model-item
          ...
          :label="$t('base.word.limit')"
        >
          <a-switch v-model="activeData['show-word-limit']" />
        </a-form-model-item>
        <a-form-model-item
          v-if="activeData.__config__.tag === 'a-cascader'"
          :label="$t('base.expand.trigger')"
        >
          <a-radio-group
      ...
      >
        ...
        <a-form-model-item
          ...
          :label="$t('base.form.label.span')"
        >
          <a-input v-model="formConf.labelCol.span" />
        </a-form-model-item>
        <a-form-model-item
          v-if="formConf.layout === 'horizontal'"
          :label="$t('base.form.label.offset')"
        >
          <a-input v-model="formConf.labelCol.offset" />
        </a-form-model-item>
        <a-form-model-item
          v-if="formConf.layout === 'horizontal'"
          :label="$t('base.form.wrapper.span')"
        >
          <a-input v-model="formConf.wrapperCol.span" />
        </a-form-model-item>
        <a-form-model-item
          v-if="formConf.layout === 'horizontal'"
          :label="$t('base.form.wrapper.offset')"
        >
...
export default {
  ...
  computed: {
    documentLink() {
      return this.activeData.__config__.document || this.$t("tag.document");
    },
    tagList() {
      return [
        {
  ...
  methods: {
    ...
    handleAutoDataSourceClose(removedTag) {
      const dataSource = this.activeData["data-source"].filter(
        (tag) => tag !== removedTag
      );
    ...
    handleInputAutoDataSourceConfirm() {
      ...
      if (
        ...
        dataSource = [
          ...dataSource,
          {
            label: inputAutoDataSourceValue,
            value: inputAutoDataSourceValue,
          },
        ];
      }
